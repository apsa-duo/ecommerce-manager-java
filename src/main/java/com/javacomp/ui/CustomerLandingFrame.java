...
/**
 * Customer landing page — choose to log in or register a new account.
 *
 * @author Andrea Pascual Aguilera
 * @author Sergio Alonso Zarcero
 */
public class CustomerLandingFrame extends javax.swing.JFrame {

    public CustomerLandingFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Are you a registered customer?");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new CustomerLandingFrame().setVisible(true));
    }
